...
#line 1104 "gramatica1.tab.c"
    break;

  case 5: /* line: NEWLINE  */
#line 51 "gramatica1.y"
              { 
        /* línea vacía */ 
        pos = 0;
    }
#line 1113 "gramatica1.tab.c"
    break;

  case 6: /* line: error NEWLINE  */
#line 55 "gramatica1.y"
                    { 
        printf("NO ACEPTA\n"); 
        pos = 0;
        yyerrok; 
    }
#line 1123 "gramatica1.tab.c"
    break;

  case 9: /* digit: ZERO  */
#line 66 "gramatica1.y"
            { number_str[pos++] = '0'; }
#line 1129 "gramatica1.tab.c"
    break;

  case 10: /* digit: ONE  */
#line 67 "gramatica1.y"
            { number_str[pos++] = '1'; }
#line 1135 "gramatica1.tab.c"
    break;


#line 1139 "gramatica1.tab.c"
