...
/* Función para verificar si una cadena es capicúa */
...
/* Función para verificar si el archivo tiene extensión .txt */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ERROR_CHAR = 6,                 /* ERROR_CHAR  */
...
static const char *const yytname[] =
{
  ...
  "NEWLINE", "ERROR_CHAR", "$accept", "program", "line", "number", "digit", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: number NEWLINE  */
#line 40 "gramatica1.y"
                     { 
...
#line 1103 "gramatica1.tab.c"
    break;

  case 5: /* line: NEWLINE  */
#line 50 "gramatica1.y"
              { 
        /* línea vacía */ 
        pos = 0;
    }
#line 1112 "gramatica1.tab.c"
    break;

  case 6: /* line: error NEWLINE  */
#line 54 "gramatica1.y"
                    { 
        printf("NO ACEPTA\n"); 
        pos = 0;
        yyerrok; 
    }
#line 1122 "gramatica1.tab.c"
    break;

  case 9: /* digit: ZERO  */
#line 65 "gramatica1.y"
            { number_str[pos++] = '0'; }
#line 1128 "gramatica1.tab.c"
    break;

  case 10: /* digit: ONE  */
#line 66 "gramatica1.y"
            { number_str[pos++] = '1'; }
#line 1134 "gramatica1.tab.c"
    break;


#line 1138 "gramatica1.tab.c"
